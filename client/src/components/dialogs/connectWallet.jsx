import { Box, Button, Divider, Stack, Typography, Dialog } from '@mui/material';
import { argent, braavos, useAccount, useConnect } from "@starknet-react/core";
import { motion } from "framer-motion";
import background from "../../assets/images/blessing_caster.png";
        ...
        <Box sx={styles.container}>
          ...
          <Box sx={styles.providerContainer}>
            ...
            <Box sx={{ mt: 1, display: 'flex', flexDirection: 'column', gap: 2 }}>
              <Button variant='outlined' onClick={() => connect({ connector: cartridgeConnector })} size='large' startIcon={<SportsEsportsIcon color='primary' />}>
                <Typography color='primary'>
                  Cartridge Controller
                </Typography>
              </Button>
              <Typography variant='subtitle1' sx={{ fontSize: '12px' }} textAlign='center'>
                Cartridge Controller offers a smooth tx less gaming experience
              </Typography>
