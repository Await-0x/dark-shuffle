...
slot deployments create darkshuffle-slot katana --version v1.0.1 --invoke-max-steps 25000000 --block-time 1000 --dev --dev.no-fee
...
cp ../contracts/manifest_slot.json ../client/manifest_slot.json
